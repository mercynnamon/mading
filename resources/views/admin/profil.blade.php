...
<head>
    ...
    <title>Profil Admin - E-Mading</title>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                <i class="fas fa-user me-2"></i>Admin - Profil
            </a>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ route('admin.profil') }}">Profil</a></li>
                </ul>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="mb-0"><i class="fas fa-user me-2"></i>Profil Admin</h4>
        </div>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-4">
                                <h3 class="text-primary">{{ \App\Models\Artikel::whereHas('likes', function($q) { $q->where('id_user', auth()->user()->id_user); })->count() }}</h3>
                                <p class="text-muted">Artikel Disukai</p>
                            </div>
                            <div class="col-md-4">
                                <h3 class="text-success">{{ \App\Models\Komentar::where('id_user', auth()->user()->id_user)->count() }}</h3>
