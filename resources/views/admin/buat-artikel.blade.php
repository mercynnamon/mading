...
<head>
    ...
    <title>Buat Artikel Baru - Admin E-Mading</title>
    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Bagikan informasi dan konten berkualitas untuk komunitas</p>
            </div>
            ...
            <div class="form-body">
                ...
                <form method="POST" action="{{ route('admin.artikel.store') }}" enctype="multipart/form-data" id="articleForm">
                    @csrf
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-3 mb-0">
                            ...
                            Artikel akan langsung dipublikasi
                        </p>
                    </div>
                </form>
            </div>
