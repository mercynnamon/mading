...
<head>
    ...
    <title>Tambah User - Admin E-Mading</title>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                ...
                <span>Tambah</span>
                <span style="color: #ffd700;">User</span>
            </a>
    ...
    <div class="container mt-4">
        ...
        <div class="hero-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="hero-title"><i class="fas fa-user-plus me-3"></i>Tambah User Baru</h1>
                    <p class="hero-subtitle">Buat akun pengguna baru untuk sistem E-Mading Baknus</p>
                </div>
