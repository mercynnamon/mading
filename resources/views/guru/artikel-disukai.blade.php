...
<head>
    ...
    <title>Artikel Disukai - Guru E-Mading</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('guru.artikel-pending') }}">Artikel Pending</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ route('guru.artikel-disukai') }}">Artikel Disukai</a></li>
