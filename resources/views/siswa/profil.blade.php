...
<head>
    ...
    <title>Profil Siswa - E-Mading</title>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="{{ route('siswa.dashboard') }}">
                <i class="fas fa-user me-2"></i>Siswa - Profil
            </a>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('siswa.dashboard') }}">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link active" href="{{ route('siswa.profil') }}">Profil</a></li>
                </ul>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="mb-0"><i class="fas fa-user me-2"></i>Profil Siswa</h4>
        </div>
